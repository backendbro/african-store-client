    ...
    categories.forEach((category) => {
      categoryContainer.innerHTML += `
            <div class="col md-mb-25px">
              <a href="./store/single-category%20page/index.html?id=${category.id}" class="justify-content-center mb-10px">
                <img src="${category.categoryDisplay}" class="border-radius-4px w-100" alt="${category.name}" />
              </a>
              <a href="./store/single-category%20page/index.html?id=${category.id}" class="btn btn-hover-animation fw-500 text-uppercase-inherit justify-content-center pt-0 pb-0">
                <span>
